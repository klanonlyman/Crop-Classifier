...
def swin_large_patch4_window7_384_in1k(num_classes: int = 21841, **kwargs):
    model = SwinTransformerV2(img_size=384, patch_size=4, in_chans=3, num_classes=num_classes,
